            ...
            <div class="box_row clearfix" style="display: inline-block;">
              <div class="widget-tasks-statistics">
                <div class="userstats clearfix" style="margin-top: 25px;">
                    ...
                    <div class="widget">
                      <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120px"></canvas><input class="knob" data-width="120" data-height="120" data-displayinput="false" data-readonly="true" data-thickness=".15" value="37" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                    </div>
                    <p><strong>+530</strong>Visitantes deste mês</p>
                  </a>
                </div>
              </div>
              <div class="widget-tasks-statistics">
                <div class="userstats clearfix" style="margin-top: 25px;">
                    ...
                    <div class="widget">
                      <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120px"></canvas><input class="knob" data-width="120" data-height="120" data-displayinput="false" data-readonly="true" data-thickness=".15" value="13" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                    </div>
              ...
              <div class="widget-tasks-statistics">
                <div class="userstats clearfix" style="margin-top: 25px;">
                    ...
                    <div class="widget">
                      <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120px"></canvas><input class="knob" data-width="120" data-height="120" data-displayinput="false" data-readonly="true" data-thickness=".15" value="15" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                    </div>
            ...
            <div class="box_row clearfix" style="display: inline-block;">
              <div class="widget-tasks-statistics">
                <div class="userstats clearfix" style="margin-top: 25px;">
                    ...
                    <div class="widget">
                      <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120px"></canvas><input class="knob" data-width="120" data-height="120" data-displayinput="false" data-readonly="true" data-thickness=".15" value="55" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                    </div>
              ...
              <div class="widget-tasks-statistics">
                <div class="userstats clearfix" style="margin-top: 25px;">
                    ...
                    <div class="widget">
                      <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120px"></canvas><input class="knob" data-width="120" data-height="120" data-displayinput="false" data-readonly="true" data-thickness=".15" value="35" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                    </div>
              ...
              <div class="widget-tasks-statistics">
                <div class="userstats clearfix" style="margin-top: 25px;">
                    ...
                    <div class="widget">
                      <div style="display:inline;width:120px;height:120px;"><canvas width="120" height="120px"></canvas><input class="knob" data-width="120" data-height="120" data-displayinput="false" data-readonly="true" data-thickness=".15" value="97" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                    </div>
        ...
        <div class="row-fluid">
          ...
          <div class="row-fluid">
            ...
            <div class="widget widget-padding span8">
              ...
              <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 170px;"><div class="widget-body clearfix" style="height: 170px; overflow: hidden; width: auto;" id="widget-tasks">
                <div class="widget-tasks-statistics">
                  <div class="userstats clearfix" style="margin-top: 25px;">
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                      <img src="assets/img/avatars/07.jpg" class="image">
                      <div class="widget">
                        <div style="display:inline;width:75px;height:75px;"><canvas width="75" height="75px"></canvas><input class="knob" data-width="75" data-height="75" data-displayinput="false" data-readonly="true" data-thickness=".3" value="85" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>   
                      </div>
                      <p>Fernando</p>
                    </a>
                  </div>
                  <div class="userstats clearfix">
                      ...
                      <div class="widget">
                        <div style="display:inline;width:75px;height:75px;"><canvas width="75" height="75px"></canvas><input class="knob" data-width="75" data-height="75" data-displayinput="false" data-readonly="true" data-thickness=".3" value="55" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>      
                      </div>
                      <p>Milagros</p>
                    </a>
                  </div>
                  <div class="userstats clearfix">
                      ...
                      <div class="widget">
                        <div style="display:inline;width:75px;height:75px;"><canvas width="75" height="75px"></canvas><input class="knob" data-width="75" data-height="75" data-displayinput="false" data-readonly="true" data-thickness=".3" value="25" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>      
                      </div>
                      <p>Lilia</p>
                    </a>
                  </div>
                  <div class="userstats clearfix">
                      ...
                      <div class="widget">
                        <div style="display:inline;width:75px;height:75px;"><canvas width="75" height="75px"></canvas><input class="knob" data-width="75" data-height="75" data-displayinput="false" data-readonly="true" data-thickness=".3" value="15" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>      
                      </div>
                      <p>Cody</p>
                    </a>
                  </div>
                  <div class="userstats clearfix">
                      ...
                      <div class="widget">
                        <div style="display:inline;width:75px;height:75px;"><canvas width="75" height="75px"></canvas><input class="knob" data-width="75" data-height="75" data-displayinput="false" data-readonly="true" data-thickness=".3" value="10" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>      
                      </div>
                      <p>John</p>
                    </a>
                  </div>
                  <div class="userstats clearfix">
                      ...
                      <div class="widget">
                        <div style="display:inline;width:75px;height:75px;"><canvas width="75" height="75px"></canvas><input class="knob" data-width="75" data-height="75" data-displayinput="false" data-readonly="true" data-thickness=".3" value="9" readonly="readonly" style="display: none; width: 0px; visibility: hidden;"></div>      
                      </div>
                      <p>Bryan</p>
                    </a>
                  </div>
                ...
                <ul>
                  <li>
                    ...
                    <div class="comment-bubble">
                      ...
                      <div class="date">Thursday</div>
                      <div class="settings">
                        <a href="javascript:void(0)" class="tip" data-title="Reply" data-original-title=""><i class="icon-reply"></i></a><a href="javascript:void(0)" class="tip" data-title="Delete" data-original-title=""><i class="icon-trash"></i></a><a href="javascript:void(0)" class="tip" data-title="Edit" data-original-title=""><i class="icon-edit"></i></a>
                      </div>
                    </div>
                  </li>
                  <li>
