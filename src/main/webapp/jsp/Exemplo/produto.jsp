					...
					<form class="form-horizontal">
						<div class="control-group">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select tabindex="1" data-placeholder="Selecione.."
										class="span7">
										<option value=""></option>
							...
							<br /> <label class="control-label">Fabricante</label>
							<div class="controls">
								<input class="span7" type="text" placeholder="fabricante">
							</div>
							<br /> <label class="control-label">Embalagem de Compra</label>
							<div class="controls">
								<input class="span7" type="text" placeholder="embcompra">
							</div>
							<br /> <label class="control-label">Embalagem de Venda</label>
							<div class="controls">
								<input class="span7" type="text" placeholder="embvenda">
							</div>
							<br /> <label class="control-label">Codigo de Barras</label>
							<div class="controls">
								<input class="span7" type="text" placeholder="bairro">
							</div>
							<br /> <label class="control-label">Nome Popular:</label>
							<div class="controls">
								<input class="span7" type="text" placeholder="telefone">
							</div>
							<br /> <label class="control-label">Quantidade da
								Embalagem</label>
							<div class="controls">
								<input class="span7" type="text" placeholder="qtdembalagem">
							</div>
							<br /> <label class="control-label">Fração</label>
							<div class="controls">
								<input class="span7" type="checkbox" placeholder="fracao">Fração
							</div>
							<br /> <label class="control-label">Unidade Fração</label>
							<div class="controls">
